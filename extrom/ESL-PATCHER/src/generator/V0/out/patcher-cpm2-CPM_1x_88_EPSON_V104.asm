_BIOS_CPM_1x_88_EPSON_V104:
	...
	dwpatch	0xdeb4+1	,0xE614	,_CPM2_res_GETINFO
	dwstore	_CPM2__old_read+1	,0xDEE5
	dwstore	_CPM2__old_write+1	,0xE01B
	dwstore	_CPM2__old_getinfo+1	,0xE614
	dbpatch	0xE654		,0x21	,0x21
	dwpatch	0xE654+1 	,0xE684	,0xE684
	dwstore	_CPM2__old_getinfo_chkdo+1	,0xE654
