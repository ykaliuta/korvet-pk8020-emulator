_BIOS_MICRODOS_OPTS2_900105:
	...
	dbpatchmaybe	0xF04E	,0x1B	,0x0d
	dbpatchmaybe	0xF04E+1	,0x45	,0x0d
	...
	dwpatch	0xEAFF+1	,0xEB36	,MD_READ			
	dwpatch	0xEB04+1	,0xEBA0	,MD_WRITE
	...
	dbpatch	0xEC87	,0xcd	,0x00
	dwpatch	0xEC87+1	,0xEE14	,0x0000

	;GET_INFO_CALL_READ------------------------------------------------------
	;подменяем чтение сектора с диска на нашу функцию
	dwpatch	0xEC8A+1	,0xEE1E	,MD_READ_INFOSECTOR
	...
	dwpatch 0xc01b+1	 ,0xdd4c	,md_res_seldsk
	dwstore md_old_seld_dsk+1,0xdd4c	,0xdd4c
	...
	dwpatch	0xc000+1	,0xC487 ,0xC487
	dwpatch	0xc003+1	,0xDBC0 ,0xDBC0
	dbpatch	0xbe07+1	,0x02 ,0x02
	dbpatch	0xEC42	,0x21 ,0x21

	;STOP-------------------------------------------------------------------------------
	stop 'MICRODOS_OPTS2_900105'
	;'MICRODOS_2_900105'
