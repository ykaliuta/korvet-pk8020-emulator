_BIOS_CPM_21_89___wiza:
	...
	;
	;значения вида CPM_21_89___wiza должны быть заменены на значения
	...
	dwpatch 0xDCCC+5*2 	,0x0000 ,_CPM1_dph_F
	...
	dwpatch 0xDA1B+1 	,0xDC8D	,_CPM1_res_seldsk
	dwstore	_CPM1_old_seld_dsk+1	,0xDC8D
	...
	dwstore	_CPM1_r_p_SELDSKDRIVER+1	,0xE06E
	dwstore	_CPM1_r_p_SELDSKDRIVEW+1	,0xE06E
	...
	dwpatch	0xDA27+1	,0xDCEB	,_CPM1_res_READ
	dwpatch	0xDA2A+1	,0xDEAF	,_CPM1_res_WRITE
	...
	dwpatch	0xDB84+1	,0xDCEB	,_CPM1_res_READ
	...
	dwpatch	0xdcbf+1	,0xE648	,_CPM1_res_GETINFO

	;BIOS_xxxx--------------------------------------------------------------
	;сохраняем в "резидет" адреса оригинальных функций
	;они вызываются если идёт обращение к физичесским дискам

	dwstore	_CPM1__old_read+1	,0xDCEB
	dwstore	_CPM1__old_write+1	,0xDEAF
	dwstore	_CPM1__old_getinfo+1	,0xE648
	...
	dbpatch	0xE67F		,0x21	,0x21
	dwpatch	0xE67F+1 	,0xE6AF	,0xE6AF

	;и устанавливаем в наш "резидент" переход на эту точку.
	
	dwstore	_CPM1__old_getinfo_chkdo+1	,0xE67F
	...
	dwstore	_CPM1_r_p_DSK1+1	,0xE064 	;read
	dwstore	_CPM1_r_p_TRK1+1	,0xE068 	
	dwstore	_CPM1_r_p_SEC1+1	,0xE069 	
	dwstore	_CPM1_r_p_DMA1+1	,0xE06A 	

	dwstore	_CPM1_r_p_DSK2+1	,0xE064 	;write
	dwstore	_CPM1_r_p_TRK2+1	,0xE068 	
	dwstore	_CPM1_r_p_SEC2+1	,0xE069 	
	dwstore	_CPM1_r_p_DMA2+1	,0xE06A 	

	dwstore	_CPM1_r_p_DSK3+1	,0xE064 	;readinfo
	...
	;custom checkers
	dwpatch	0xDCBB+1	,0xE06E ,0xE06E

	;STOP-------------------------------------------------------------------------------
	stop 'CPM_21_89___wiza'
