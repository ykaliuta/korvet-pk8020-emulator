_BIOS_:NAME::
	...
	dbpatchmaybe	:_CPM2_BIOS_LOGO:	,0x1F	,0x0d
	dbpatchmaybe	:_CPM2_BIOS_LOGO:+2	,0x0a	,0x0d
	...
	;RAM:E4A4 C9                       ret
	dbpatch	:_CPM2_PPI2C_BIOS_INIT:+1	,0x49	,0xc9
	...
	dbpatch	:_CPM2_DRVREG_A: 	,0x01	,0x00
	dbpatch	:_CPM2_DRVREG_B: 	,0x02	,0x00
	dbpatch	:_CPM2_DRVREG_C: 	,0x04	,0x01
	dbpatch	:_CPM2_DRVREG_D: 	,0x08	,0x02
	...
	dwstore	_CPM2_res_DRIVE_TAB+0*2	,:_CPM2_DRVREG_A:
	dwstore	_CPM2_res_DRIVE_TAB+1*2	,:_CPM2_DRVREG_B:
	dwstore	_CPM2_res_DRIVE_TAB+2*2	,:_CPM2_DRVREG_C:
	dwstore	_CPM2_res_DRIVE_TAB+3*2	,:_CPM2_DRVREG_D:

	;DPH_TABLE-----------------------------------------------------
	;добавляем поддержку диска F - образа с утилитами
	;как найти DPH_TABLE см выше
	dwpatch :_CPM2_DPH_TABLE:+5*2 	,0x0000 ,_CPM2_dph_F

	dwstore _CPM2_dph_F+8	,:_CPM2_DIR_BUF:
	...
	dwpatch 0xDA1B+1 	,:_CPM2_SELDSK_ADDR:	,_CPM2_res_seldsk
	dwstore	_CPM2_old_seld_dsk+1	,:_CPM2_SELDSK_ADDR:
	...
	dbpatch	:_CPM2_SELDSK_STORE_DRV:	,0x77	,0x00
	...
	dwstore	_CPM2_r_p_SELDSKDRIVER+1	,:_CPM2_CURRENT_DISK_PTR:
	dwstore	_CPM2_r_p_SELDSKDRIVEW+1	,:_CPM2_CURRENT_DISK_PTR:
	...
	dwpatch	0xDA27+1	,:_CPM2_BIOS_READ:	,_CPM2_res_READ
	dwpatch	0xDA2A+1	,:_CPM2_BIOS_WRITE:	,_CPM2_res_WRITE
	...
	dwpatch	:_CPM2_WBOOT_READ_CALL:+1	,:_CPM2_BIOS_READ:	,_CPM2_res_READ
	...
	dwpatch	:_CPM2_SELDSK_GETINFO_CALL:+1	,:_CPM2_BIOS_GETINFO:	,_CPM2_res_GETINFO

	;BIOS_xxxx--------------------------------------------------------------
	;сохраняем в "резидет" адреса оригинальных функций
	;они вызываются если идёт обращение к физичесским дискам

	dwstore	_CPM2__old_read+1	,:_CPM2_BIOS_READ:
	dwstore	_CPM2__old_write+1	,:_CPM2_BIOS_WRITE:
	dwstore	_CPM2__old_getinfo+1	,:_CPM2_BIOS_GETINFO:
	...
	dbpatch	:_CPM2_GETINFO_POSTDTOM_ADDR:		,0x21	,0x21
	dwpatch	:_CPM2_GETINFO_POSTDTOM_ADDR:+1 	,:_CPM2_GETINFO_POSTDTOM_CHKW:	,:_CPM2_GETINFO_POSTDTOM_CHKW:

	;и устанавливаем в наш "резидент" переход на эту точку.
	
	dwstore	_CPM2__old_getinfo_chkdo+1	,:_CPM2_GETINFO_POSTDTOM_ADDR:
	...
	dwstore	_CPM2_r_p_DSK1+1	,:_CPM2_BIOS_VAR_DSK: 	;read
	dwstore	_CPM2_r_p_TRK1+1	,:_CPM2_BIOS_VAR_TRK: 	
	dwstore	_CPM2_r_p_SEC1+1	,:_CPM2_BIOS_VAR_SEC: 	
	dwstore	_CPM2_r_p_DMA1+1	,:_CPM2_BIOS_VAR_DMA: 	

	dwstore	_CPM2_r_p_DSK2+1	,:_CPM2_BIOS_VAR_DSK: 	;write
	dwstore	_CPM2_r_p_TRK2+1	,:_CPM2_BIOS_VAR_TRK: 	
	dwstore	_CPM2_r_p_SEC2+1	,:_CPM2_BIOS_VAR_SEC: 	
	dwstore	_CPM2_r_p_DMA2+1	,:_CPM2_BIOS_VAR_DMA: 	

	dwstore	_CPM2_r_p_DSK3+1	,:_CPM2_BIOS_VAR_DSK: 	;readinfo
	...
	;support removed
	;dwpatch	#_CPM2_VINTKBDADDR#	,#_CPM2_VINTKBDVALUE#	,#_CPM2_KBD_HOOK_PROC#
	;dwstore	_CPM2_old_hook+1	,#_CPM2_VINTKBDVALUE#
